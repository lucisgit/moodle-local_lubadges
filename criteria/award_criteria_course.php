...
/**
 * This file contains the course completion LU Badge instance award criteria type class.
 *
...
class award_criteria_course extends award_criteria {
    ...
    public function config_form_criteria($data) {
        ...
        $editurl = new moodle_url('/local/lubadges/criteria_settings.php', array('badgeid' => $this->badgeid, 'edit' => true, 'type' => $this->criteriatype, 'crit' => $this->id));
        $deleteurl = new moodle_url('/local/lubadges/criteria_action.php', array('badgeid' => $this->badgeid, 'delete' => true, 'type' => $this->criteriatype));
