...
/**
 * LU Badge instance award criteria.
 *
...
abstract class award_criteria {
    ...
    public static function build($params) {
        ...
        require_once($CFG->dirroot . '/local/lubadges/criteria/' . $class . '.php');
    ...
    public function config_form_criteria($data) {
        ...
        $editurl = new moodle_url('/local/lubadges/criteria_settings.php',
                array('badgeid' => $this->badgeid, 'edit' => true, 'type' => $this->criteriatype, 'crit' => $this->id));
        $deleteurl = new moodle_url('/local/lubadges/criteria_action.php',
