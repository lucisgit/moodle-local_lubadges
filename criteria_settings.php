...
/**
 * Page for editing LU Badge instance criteria settings.
 *
...
require_once($CFG->dirroot . '/local/lubadges/criteria_form.php');
...
$return = new moodle_url('/local/lubadges/criteria.php', array('id' => $badgeid));
...
$PAGE->set_url('/local/lubadges/criteria_settings.php', $urlparams);
...
if (!empty($addcourse)) {
    if ($data = $mform->get_data()) {
        ...
        redirect(new moodle_url('/local/lubadges/criteria_settings.php',
