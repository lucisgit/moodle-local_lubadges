...
/**
 * Processing actions with LU Badge instance criteria.
 *
...
$PAGE->set_url('/local/lubadges/criteria_action.php');
...
if ($delete && has_capability('moodle/badges:configurecriteria', $context)) {
    ...
    if (!$confirm) {
        ...
        echo $OUTPUT->header();
        $formcontinue = new single_button(new moodle_url('/local/lubadges/criteria_action.php', $optionsyes), get_string('yes'));
